...
def getdata(filename='./FJSSPinstances/0_BehnkeGeiger/Behnke1.fjs'):
    ...
    # filename='./FJSSPinstances/Brandimarete/BrandimarteMk1.fjs'
    # filename='./FJSSPinstances/0_BehnkeGeiger/Behnke1.fjs'
    # filename='./FJSSPinstances/Hurink_sdata/HurinkSdata1.fjs'
    f=open(filename,'r')
    line=f.readline()
...
# print(operations_machines)
    ...
    return Data
#data=getdata('./FJSSPinstances/Brandimarete/BrandimarteMk6.fjs')
#print(data)
    # print(largeM)
